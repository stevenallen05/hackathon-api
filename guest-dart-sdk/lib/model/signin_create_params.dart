...
class SigninCreateParams {
  ...
  @override
  String toString() {
    return 'SigninCreateParams[guestEmailTemplateId=$guestEmailTemplateId, hostEmailTemplateId=$hostEmailTemplateId, hostIds=$hostIds, locationId=$locationId, sendNotifications=$sendNotifications, smsMessage=$smsMessage, firstName=$firstName, lastName=$lastName, company=$company, email=$email, invitationId=$invitationId, ]';
  }
